...
public class MyListner implements ITestListener {
	...
	public void onTestFailure(ITestResult result) {
		...
		try {
			FileUtils.copyFile(src, new File("D:\\images\\" + result.getMethod().getMethodName() + ".png"));
			String file = test.addScreenCapture("D:\\images\\" + result.getMethod().getMethodName() + ".png");
