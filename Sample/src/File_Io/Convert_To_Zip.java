...
public class Convert_To_Zip {
	public static void main( String[] args )
	  {
		Convert_To_Zip zipObj = new Convert_To_Zip();
	    zipObj.gzipMyFile();
	  }
	  ...
	  public void gzipMyFile(){ 
	    ...
	    try{
	      ...
	      GZIPOutputStream gos = 
	       new GZIPOutputStream(new FileOutputStream("D://java//Myfile.gz"));
	 
	      //Specify location of Input file here
	      FileInputStream fis = 
	       new FileInputStream("D://java//nmyfile.txt");
